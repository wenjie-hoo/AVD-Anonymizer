...
model = dict(
    ...
    kd_cfg=dict(
        loss_cls_kd=dict(type='KDQualityFocalLoss', beta=1, loss_weight=0.1),
        loss_reg_kd=dict(type='GIoULoss', loss_weight=0.1),
...
optim_wrapper = dict(
    type='OptimWrapper',
    optimizer=dict(type='SGD', lr=1e-4, momentum=0.9, weight_decay=0.01))
