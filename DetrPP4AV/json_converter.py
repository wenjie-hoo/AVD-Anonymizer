...
def convert_annotations(
    annotation_dir, train_image_dir, val_image_dir, train_images, val_images
):
    train_annotations = {
        "images": [],
        "annotations": [],
        "categories": [{"id": 0, "name": "face"}, {"id": 1, "name": "license plate"}],
    }
...
train_image_dir = "./dataset/combine_images/train/"
val_image_dir = "./dataset/combine_images/val/"
annotation_dir = "./dataset/combine_labels/"

train_images = get_image_list(train_image_dir)
val_images = get_image_list(val_image_dir)

train_annotations, val_annotations = convert_annotations(
    annotation_dir, train_image_dir, val_image_dir, train_images, val_images
)
